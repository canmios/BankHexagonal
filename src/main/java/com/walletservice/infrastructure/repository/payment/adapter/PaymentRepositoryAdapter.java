package com.walletservice.infrastructure.repository.payment.adapter;

import com.walletservice.domain.model.payment.Payment;
import com.walletservice.domain.model.payment.PaymentState;
import com.walletservice.domain.repository.PaymentRepository;
import com.walletservice.infrastructure.repository.payment.PaymentEntityRepository;
import com.walletservice.infrastructure.repository.payment.PaymentStateEntityRepository;
import com.walletservice.infrastructure.repository.payment.entity.PaymentEntity;
import com.walletservice.infrastructure.repository.payment.entity.PaymentStateEntity;
import com.walletservice.infrastructure.repository.payment.mapper.PaymentRepositoryMapper;
